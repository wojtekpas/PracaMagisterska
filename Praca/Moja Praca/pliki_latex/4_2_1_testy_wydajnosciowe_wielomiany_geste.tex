...
Także i w tym przypadku porónwywane czasy działania są prawie identyczne. Ich wartości w zależności od stopnia tesstowanego wielomianu zostały przedstawione na poniższym wykresie.
...
\subsubsection{Wielomiany o losowych współczynnikach}
