...
mpq_t simple_function(int a, int b)
{
	...
	number1 = new Number(a);
	number2 = new Number(b);
	number3 = new Number(a*b)
	number4 = new Number();
	if (number1 > number2)
