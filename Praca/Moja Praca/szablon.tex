...
\begin{definition}
	...
	\begin{equation}
	\begin{split}
	&W(x) = a_0x^m + a_1x^{m-1} a_2x+ ... + a_{m-1}x + a_m, \\
	&gdzie\ liczby\ a_0, a_1, a_2, ..., 1_{m-1}, a_m\ są liczbami\ rzeczywistymi
	\end{split}
	\label{eq:lin:defPolynomialeq}
	\end{equation}
	\label{eq:lin:defPolynomial}
\end{definition}
